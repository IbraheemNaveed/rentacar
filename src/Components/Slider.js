...
<button className=" hover:fill-red-900 prevElem ">
...
<button className=' border-2 bg-clip-border px-8 sm:px-14 py-4 border-[#171717] text-[#171717] mx-4 dark:bg-gray-800  ' > {text}</button>
<button className="text-[#171717] hover:text-black nextElem ">
<svg width="49" height="16" viewBox="0 0 49 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
