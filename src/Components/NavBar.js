...
export default function Navbar() {
  ...
  return (
    <Fragment>
      <nav className="p-5   md:flex firstBackgroundProperty">
        <div className="flex    justify-between lg:w-full   ">
          <div className="flex mx-4 lg:mx-auto">
            ...
            />
            <img className=" w-32 mr-28 " src={Logo} />
            <ul
      ...
      <ul
        ref={mobileNavBar}
        className={`mobile-navbar  lg:hidden w-[80vw] h-[100vh]  lg:items-center z-10 opacity-100 lg:z-auto lg:static absolute  lg:w-auto lg:py-0 py-4 lg:pl-0 pl-7 md:opacity-100  left-[-800px]  text-black  bg-white transition-all ease-in duration-500  lg:mx-[60px] `}
      >
