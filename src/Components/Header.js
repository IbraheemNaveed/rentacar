...
function Header() {
  return (
    <div>
<div className=" mt-1 bg-[#171717] ml-4 mr-4 ">
<div className="h-16  bg-[#6AE6B0] mt-7 blur-[250px] absolute "></div>
<h1 className=" pt-4 text-center text-3xl sm:text-6xl font-bold mt-10  meet1 text-[#FAFAFA]">
BISSMILLAH
</h1>
<h1 className=" mt-3 text-center text-3xl sm:text-6xl  font-bold  text-transparent bg-clip-text bg-gradient-to-l from-[#4ade80]/30 to-[#6ee7b7]/70 ">
RENT A CAR
</h1>
